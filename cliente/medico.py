...
"background-color: rgb(0, 0, 127);")
    ...
    #Função responsável por indicar o paciente selecionado no listwidjet de pacientes 
    def listwidgetclicked(self, item):
        self.paciente = item.data(QtCore.Qt.UserRole)

    #Função responsável por atualizar os dados do paciente selecionado , na tela
    ...
    def retranslateUi(self, MainWindow):
        ...
        #instancia da thread criada para enviar o sinal ou dados para as funções de manipular a lista de pacientes e atualizar
    ...
    #Função que retorna o paciente selecionado pelo id
    def get_paciente(self) -> dict:
        return requests.get(url=f'{heroku}/patient/{self.paciente["id"]}').json()


    #Função que retorna a lista de N pacientes mais graves presentes na base de dados da api/nuvem
    def listar_pacientes(self) -> dict:
        self.rq = requests.get(url=f'{heroku}/get/patients/{ui.spinBox.value()}').json()
        return self.rq

    #Esta função é responsável por fazer a inserção da lista de N  pacientes mais grave no listWidjet 
